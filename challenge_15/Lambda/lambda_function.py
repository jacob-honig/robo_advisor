...
def validate_data(age, investment_amount, intent_request):
    ...
    # Validate that the age input should be greater than zero and less than 65.
    if age is not None:
        age = parse_int(age)
        if age <= 0 or age > 65:
            return build_validation_result(
                False,
                "age",
                "You must be between 0 and 65 years of age to use this service."
    ...
    if investment_amount is not None:
        ...
        if investment_amount <= 5000:
            return build_validation_result(
                ...
                "Please provide a another investment amount.",
            )

    # True results is returned if age and amount are valid
...
def recommend_portfolio(intent_request):
    ...
    # Parse "risk_level" as string and convert to uppercase
    ...
    if source == "DialogCodeHook":
        ...
        # Validates input data using the validate_data function
        validation_result = validate_data(age, investment_amount, intent_request)
        
        # If the data provided by the user is invalid, the elicitSlot dialog action is used to reprompt for the first violation detected.
        ...
        # Once the slots are valid, a delegate dialog is returned to Lex to choose next course of action.
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            your portfolio mix should be {}.
            """.format(
                first_name, response_text
            ),
        },
    )
